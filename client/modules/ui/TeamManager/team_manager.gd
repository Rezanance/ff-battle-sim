...
const MedalBtnScene: Resource = preload("res://client/modules/ui/MedalBtn/MedalBtn.tscn")
const Action = TeamSlots.Action
const MenuItem = ContextMenu.MenuItem

signal vivosaur_removed(vivosaur_id: String)
...
func create_medal_btn(_texture: Resource, vivosaur_id: String) -> MedalBtn:
