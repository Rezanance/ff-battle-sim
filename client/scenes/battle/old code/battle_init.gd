...
static func create_battlefield() -> void:
	...
	formations[Networking.player_info.player_id] = Formation.new(
		Vivosaur.new(player_slot1) if player_slot1 != null else null,
		Vivosaur.new(player_slot2) if player_slot2 != null else null,
		Vivosaur.new(player_slot3) if player_slot3 != null else null,
	)
	formations[Networking.opponent_info.player_id] = Formation.new(
		Vivosaur.new(opponent_slot1) if opponent_slot1 != null else null,
		Vivosaur.new(opponent_slot2) if opponent_slot2 != null else null,
		Vivosaur.new(opponent_slot3) if opponent_slot3 != null else null,
	)
...
func add_player_vivosaurs():
	...
	var vivosaurs: Dictionary[Zone, Vivosaur] = {
