...
func on_vivosaur_selected(vivosaur: Vivosaur, vivosaur_sprite_btn: TextureButton, is_player_vivo: bool):
...
func on_vivosaur_hover(vivosaur: Vivosaur, vivosaur_sprite_btn: TextureButton):
