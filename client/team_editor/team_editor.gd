...
const MedalTBtnScene = preload("res://client/components/ui/MedalBtn/MedalBtn.tscn")
...
func create_medal_btn(_texture: Resource, vivosaur_id: int) -> MedalBtn:
	var medal_btn: MedalBtn = MedalTBtnScene.instantiate()
