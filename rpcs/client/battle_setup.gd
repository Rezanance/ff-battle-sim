...
signal battle_prep_started(opponent_info: PlayerInfo, opponent_team_info: Dictionary)
signal battle_prep_time_up(battle_id: int)
signal battle_started(opponent_team_info: Dictionary)
...
func notify_battle_prep_start(opponent_info: Dictionary, opponent_team_info: Dictionary) -> void:
	battle_prep_started.emit(PlayerInfo.deserialize(opponent_info), opponent_team_info)
